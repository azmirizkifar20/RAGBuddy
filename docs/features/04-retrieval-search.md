...
- Consumed by: [05-mcp-server.md](./05-mcp-server.md), [09-project-chat.md](./09-project-chat.md) (chat-only query rewriting + reranking on top of the same `searchProject`)
